var app = angular.module("shoppingCart",[]);
	app.controller("cartCtrl", function($scope){
		...
		$scope.frozen = [
			...
			{id: 42,name:'Lapu-Lapu Fillet Black (Skin-off)',			unit:'per kg', price:600 , qty:1, image:'img/jpg/lapulapuFillet.jpg'},
			...
			{id: 47,name:'Fish Lips Shredded',							unit:'per kg', price:750 , qty:1, image:'img/jpg/fishLips.jpg'},
			{id: 48,name:'Fish Lips Whole',								unit:'per kg', price:700 , qty:1, image:'img/jpg/fishLips.jpg'},
			{id: 49,name:'Crab Claw XL',								unit:'per kg', price:1600, qty:1, image:'img/jpg/crawClaw.jpg'},
			{id: 50,name:'Crab Claw L',									unit:'per kg', price:1200, qty:1, image:'img/jpg/crawClaw.jpg'},
			{id: 51,name:'Crab Claw M',									unit:'per kg', price:1000, qty:1, image:'img/jpg/crawClaw.jpg'},
			{id: 52,name:'Crab Claw S',									unit:'per kg', price:900 , qty:1, image:'img/jpg/crawClaw.jpg'},
			{id: 53,name:'Crab Meat ',									unit:'per kg', price:900 , qty:1, image:'img/jpg/crabMeatWhite.jpg'},
			{id: 54,name:'Sea Cucumber',								unit:'per kg', price:1600, qty:1, image:'img/jpg/blackSeaCucumber.jpg'},
			...
			{id: 57,name:'Unagi/Yellow Eel Fillet',						unit:'per kg', price:700 , qty:1, image:'img/jpg/unagi.jpg'},
			{id: 58,name:'Pampano',										unit:'per kg', price:650 , qty:1, image:'http://lorempixel.com/600/450/food'},
			{id: 59,name:'Shrimp PUD (16-20)',							unit:'per kg', price:750 , qty:1, image:'img/jpg/peeledShrimpRaw.jpg'},
			{id: 60,name:'Shrimp PUD IQF (21-25)',						unit:'per kg', price:650 , qty:1, image:'img/jpg/peeledShrimpRaw.jpg'},
			{id: 61,name:'Shrimp PUD IQF (31-40)',						unit:'per kg', price:500 , qty:1, image:'img/jpg/peeledShrimpRaw.jpg'},
			{id: 62,name:'Shrimp PUD IQF (41-50)',						unit:'per kg', price:450 , qty:1, image:'img/jpg/peeledShrimpRaw.jpg'},
			{id: 63,name:'Shrimp PUD (51-60)',							unit:'per kg', price:430 , qty:1, image:'img/jpg/peeledShrimpRaw.jpg'},
			{id: 64,name:'Shrimp PUD (61-70)',							unit:'per kg', price:400 , qty:1, image:'img/jpg/peeledShrimpRaw.jpg'},
			{id: 65,name:'Shrimp PUD (71-90)',							unit:'per kg', price:390 , qty:1, image:'img/jpg/peeledShrimpRaw.jpg'},
			{id: 66,name:'Shrimp PUD (91-120)',							unit:'per kg', price:380 , qty:1, image:'img/jpg/peeledShrimpRaw.jpg'},
			{id: 67,name:'Shrimp PUD Cooked (16-20)',					unit:'per kg', price:900 , qty:1, image:'img/jpg/peeledShrimpCooked.jpg'},
			{id: 68,name:'Shrimp PUD Cooked (21-25)',					unit:'per kg', price:780 , qty:1, image:'img/jpg/peeledShrimpCooked.jpg'},
			{id: 69,name:'Shrimp PUD Cooked (31-40)',					unit:'per kg', price:600 , qty:1, image:'img/jpg/peeledShrimpCooked.jpg'},
			{id: 70,name:'Shrimp PUD Cooked (41-50)',					unit:'per kg', price:550 , qty:1, image:'img/jpg/peeledShrimpCooked.jpg'},
			{id: 71,name:'Shrimp PUD Cooked (51-60)',					unit:'per kg', price:530 , qty:1, image:'img/jpg/peeledShrimpCooked.jpg'},
			{id: 72,name:'Shrimp PUD Cooked (61-70)',					unit:'per kg', price:500 , qty:1, image:'img/jpg/peeledShrimpCooked.jpg'},
			{id: 73,name:'Shrimp PUD Cooked (71-90)',					unit:'per kg', price:490 , qty:1, image:'img/jpg/peeledShrimpCooked.jpg'},
			{id: 74,name:'Shrimp PUD Cooked (91-120)',					unit:'per kg', price:480 , qty:1, image:'img/jpg/peeledShrimpCooked.jpg'},
			{id: 75,name:'Shrimp Cooked Whole',							unit:'per kg', price:700 , qty:1, image:'http://lorempixel.com/600/450/food'},
			{id: 76,name:'Nobashi 13g',									unit:'per kg', price:9.50, qty:1, image:'img/jpg/nobashi.jpg'},
			{id: 77,name:'Nobashi 11g',									unit:'per kg', price:7.50, qty:1, image:'img/jpg/nobashi.jpg'},
			{id: 78,name:'Slipper Lobster Frozen',						unit:'per kg', price:900 , qty:1, image:'img/jpg/blackSlipperLobster.jpg'},
			...
			{id: 82,name:'Curacha',										unit:'per kg', price:490 , qty:1, image:'img/jpg/curacha.jpg'}
		];	
		...
		$scope.imported = [
			...
			{id: 98, name:'Fish Cake',											unit:'per kg', price:250 , qty:1, image:'img/jpg/fishCake.jpg'},
			...
			{id: 101,name:'Japan Scallops',										unit:'per kg', price:1700, qty:1, image:'img/jpg/japanScallops.jpg'},
			{id: 102,name:'Small Ngo Hiang',									unit:'per kg', price:450 , qty:1, image:'http://lorempixel.com/600/450/food'},
			{id: 103,name:'Squid Tube',											unit:'per kg', price:350 , qty:1, image:'img/jpg/squidRing.jpg'},
